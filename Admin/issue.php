...
<body>
	...
	<center>
		<h4><b><u>Confirm Issue Book</u></b></h4><br>
	</center>
	<div class="row">
...
<?php
	if (isset($_POST['issue_book'])) {
		...
		<?php
			...
			$query = "insert into issued_books values('','$_POST[book_no]','$_POST[book_name]','$_POST[author_name]','$_POST[student_id]',current_date,'N/A')";
		
		$query_run = mysqli_query($connection, $query);
		$query = "update books set quantity=quantity-1 where book_no=$_POST[book_no]";
		$query_run = mysqli_query($connection, $query);
		?>
		<script type="text/javascript">
