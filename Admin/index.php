	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="../index.php">LMS Pro</a>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-8" id="main_content">
			...
			if (isset($_POST['login'])) {
				...
				?>
				<br><br>
				<center><span class="alert-danger">Invalid admin credentials.</span></center>
				<?php
			}
			?>
			<div class="text-center mt-3">
				<a href="forgot_password.php">Forgot Admin Password?</a>
			</div>
		</div>
	</div>
