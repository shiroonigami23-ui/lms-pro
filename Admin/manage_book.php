...
<?php include('navbar.php')?>
	...
	<span>
		...
		Dear,<?php echo $_SESSION['name'];?> Please,Take one of the action whether edit the book or remove it!!!</b>
		</marquee>
	</span><br><br>
	<center>
		<h4><b><u>Manage Books</u></b></h4><br>
	</center>
	<div class="row">
			...
			<table class="table table-bordered table-hover">
				...
				?>
					<tr>
						...
						<td>
							<button class="btn" name=""><a href="edit_book.php?bn=<?php echo $row['book_no']; ?>"" style="color:green">Edit</a></button>
							<button class="btn"><a href="delete_book.php?bn=<?php echo $row['book_no']; ?>"" style="color:red">Delete</a></button>
						</td>
					</tr>
				<?php
				}
