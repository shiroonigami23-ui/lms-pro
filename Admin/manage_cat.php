...
<?php include('navbar.php')?>
	...
	Dear,<?php echo $_SESSION['name'];?> Please,Take one of the action whether edit the category or remove it!!!</b>
</marquee></span><br><br>
		<center><h4><b><u>Manage Category</b></u></h4><br></center>
		<div class="row">
					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>"" style="color:green">Edit</a></button>
								<button class="btn"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>"" style="color:red">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
