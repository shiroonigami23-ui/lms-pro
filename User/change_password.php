            ...
            <form method="post">
               ...
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="subject" class="form-control" placeholder="What's Your Subject *" value="" />
                        </div>
                        <div class="form-group">
                            <input type="submit" onclick="Submitted" name="submit" class="btnContact" value="Send Message" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
$message=$_POST['msg'];
    ...
    try {
        ...
        $mail->Subject = $sub;
        $mail->Body    = "<h3><b>Sender name -</b> $name <br> <b>Sender Email -</b> $email </h3><br><b>Message -</b> $message";
	...
	?>
								...
								swal({
          title: 'Message Sent!',
          text: 'Response sent to the Admin!',
          type: 'success'
        }).then(function() {
